...
public class MaterialSpinner extends TextView {
    ...
    public void setIsSelectedOwner(boolean isSelectOwner) {
        this.isSelectOwner = isSelectOwner;
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                setText(isSelectOwner ? "" : item.toString());
                collapse();
        ...
        if (savedState instanceof Bundle) {
            ...
            if (adapter != null) {
                if (nothingSelected && !TextUtils.isEmpty(hintText)) {
                    ...
                    setTextColor(textColor);
                    setText(isSelectOwner ? "" : adapter.get(selectedIndex).toString());
                }
